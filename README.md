...
S3 triggers processImage Lambda.

Lambda sends image to Rekognition, receives tags, and updates DynamoDB.

Frontend posts text data via API Gateway to postItem Lambda, saving to DynamoDB.